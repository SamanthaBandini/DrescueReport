...
\item \textbf{Singleton}: the singleton pattern was user for the Coordinator implementation to keep the process status in relation to the critical section in Ricart-Agrawala algorithm.

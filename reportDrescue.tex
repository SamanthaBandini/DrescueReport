...
\item View-Holder: the view-holder pattern was used into Android adapter to stores each of the component views inside the tag field of the Layout in order to access them without the need to look them up repeatedly. %TODO check!!!
\item Static factory: utilizzato per la creazione della connessione al database %TODO
\item Factory pattern: utilizzato per recuperare i dao delle relative tabelle del database %TODO

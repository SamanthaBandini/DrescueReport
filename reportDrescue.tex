...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\LARGE Università di Bologna, Sede di Cesena \\ Ingegneria e Scienze Informatiche LM} % Publisher
	...
	\vspace{0.90\baselineskip} % Whitespace above the title
	
	{\Huge  D-RESCUE}
	
	\vspace{0.40\baselineskip} 
	
	{\huge  Natural Disaster Alert and Rescue} % Title
	
	\vspace{0.30\baselineskip} % Whitespace below the title
	...
	\vspace{1.9\baselineskip} % Whitespace before the editors
